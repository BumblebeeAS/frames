...
{
	const auto results = (static_cast<Rotation<__ArbitraryConvention, __ArbitraryConvention>>(rot.conjugate()
	)(Rotation<__ArbitraryConvention, __ArbitraryConvention> { 0, pos.getX(), pos.getY(), pos.getZ() })
	)(static_cast<Rotation<__ArbitraryConvention, __ArbitraryConvention>>(rot));
