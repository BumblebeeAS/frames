...
public:
	constexpr Translation(double x, double y, double z) :
		x(x),
		y(y),
		z(z) {};
...
[[nodiscard]] constexpr auto operator+(
	...
	const Translation<coordinates::Frame<Origin2, FrameConvention>, Origin3>& t2
) -> Translation<coordinates::Frame<Origin1, FrameConvention>, Origin3>
{
